...
**You'll need Ubuntu Linux** — either directly, or on a Windows machine via **Windows Subsystem for Linux (WSL)** ([install guide](install-wsl.md)). Right now we publish an **x86_64 Linux** binary; ARM Linux and macOS builds are coming soon.
